...
//    
    ...
    public String toString2() {
        ...
        str.append("} -> (");
        //str.append(df4.format( this.qualidade) );
        str.append(D.valorAlvo + ":" + this.TP + ", not" + D.valorAlvo + ":" + this.FP + ") ");
        str.append("(conf=");
        str.append(df4.format(DPinfo.conf(this)));
        //str.append(", quality=" + df4.format(this.qualidade));        
        str.append(")");
