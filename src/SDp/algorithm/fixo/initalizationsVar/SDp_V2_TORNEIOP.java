...
public class SDp_V2_TORNEIOP extends SDp {
    ...
    public Pattern[] run(int paramTorneio, double similaridade, String tipoAvaliacao, int k) throws IOException {
        ...
        // Inicialização específica por Torneio
        Pattern[] I = InitializationManager.inicializarPorTorneio(tipoAvaliacao);
        ...
        for (int numeroReinicializacoes = 0; numeroReinicializacoes < 3; numeroReinicializacoes++) {
            if (numeroReinicializacoes > 0) {
                // Reinicialização com parâmetro estratégico '1'
